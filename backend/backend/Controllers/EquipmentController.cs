...
namespace backend.Controllers
{
    ...
    public class EquipmentController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<PageVO<EquipmentResponse>>> GetAll(
            [FromQuery] EntityFilter<Equipment> filter,
            [FromQuery] EntitySort<Equipment> sort, // Tự động map ?orderBy=Amount-desc
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<EquipmentResponse>> GetById(string id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<EquipmentResponse>> Update(string id, [FromBody] UpdateEquipmentRequest request)
        {
            try
            {
        ...
        [HttpPatch("{id}/status")]
        public async Task<IActionResult> UpdateStatus(string id, [FromBody] UpdateEquipmentStatusRequest request)
        {
            try
            {
